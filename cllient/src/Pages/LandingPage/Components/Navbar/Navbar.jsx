      ...
      <ul className="hidden md:flex space-x-12 text-gray-800">
        <li className="relative group">
          ...
          <ul className="absolute left-1/2 transform -translate-x-1/2 top-6 hidden group-hover:flex flex-col bg-white text-gray-800 shadow-lg rounded-md w-56">
            <li><a href="#" className="block px-4 py-2 hover:bg-[#B1C000]">Executive Search</a></li>
            <li><a href="#" className="block px-4 py-2 hover:bg-[#B1C000]">Contingency Recruiting</a></li>
        ...
        <li className="relative group">
          ...
          <ul className="absolute left-1/2 transform -translate-x-1/2 top-6 hidden group-hover:flex flex-col bg-white text-gray-800 shadow-lg rounded-md w-56">
            ...
            }}  className="block px-4 py-2 hover:bg-[#B1C000]">Job Board</a></li>
            <li><a href="#"
            onClick={()=>{
              window.location.href = "/signup"
            }}  className="block px-4 py-2 hover:bg-[#B1C000]">Submit your CV</a></li>
           
          </ul>
        </li>
        <li><a href="#" onClick={()=>{
              window.location.href = "/elevate"
            }} className=" ">Elevate</a></li>
