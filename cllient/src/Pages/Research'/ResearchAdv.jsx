...
const researchAndAdvisoryData = {
    ...
    advantages: [
      "Actionable Insights: With over 14 years of experience, we have developed a deep understanding of various industries. This enables us to derive research-driven insights to assist you in gaining a competitive edge, guiding your strategic decisions, and effectively navigating challenges.",
